...
Semester 1 introduced the academic and technical foundations of the degree, including ICT concepts, programming fundamentals, discrete mathematics, English communication, introductory cybersecurity, and Islamic studies/ethics. The uploaded projects show early-stage academic work, basic technical development, cybersecurity awareness, presentation skills, communication practice, and the beginning of practical security learning.
...
Some coursework, such as **Islamic Studies and Ethics**, was based on debate and class participation rather than a technical project artifact. It is acknowledged in this semester record, but it is not forced into a separate GitHub project folder because there is no meaningful public technical evidence to archive.
...
| Focus Areas | ICT, Programming, Discrete Mathematics, English Communication, Introductory Cybersecurity, Islamic Studies and Ethics |
...
| Course | Repository Folder | Public Project Status | Notes |
|---|---|---|---|
| Applications of Information and Communication Technologies | [`applications-of-information-and-communication-technologies/`](./applications-of-information-and-communication-technologies/) | Added | Includes presentation and lab/website development work |
| Discrete Structures | [`discrete-structures/`](./discrete-structures/) | Added | Includes relations and properties presentation |
| Functional English | [`functional-english/`](./functional-english/) | Added | Includes cybersecurity awareness presentation |
| Introduction to Cyber Security | [`introduction-to-cyber-security/`](./introduction-to-cyber-security/) | Added | Includes authorized hash cracking lab/presentation |
| Islamic Studies and Ethics | Not archived as a separate folder | Non-technical class activity | Debate and class participation component |
| Programming Fundamentals | [`programming-fundamentals/`](./programming-fundamentals/) | Added | Includes C++ firewall rule engine project |

---

## Project and Coursework Index

| Course | Project / Activity | Type | Description |
|---|---|---|---|
...
| Islamic Studies and Ethics | Debate and Class Participation | Class Activity | Covered ethical, religious, and discussion-based learning through debate and active class participation. No public technical artifact is archived. |
...
### Debate and Class Participation in Islamic Studies and Ethics

The **Islamic Studies and Ethics** component contributed to ethical understanding, discussion skills, and classroom participation. Since the activity was debate/class participation based, it is documented in the semester README rather than archived as a separate technical project.
...
- Debate and class participation
- Ethical and reflective academic discussion
...
> Islamic Studies and Ethics is not shown as a separate folder because the semester activity was debate and class participation based, with no separate public artifact to archive.

---

## Project Status Summary

| Project / Activity | Status | Portfolio Role |
|---|---|---|
| Firewall Rule Engine in C++ | Runnable | Supporting coding project |
| Hash Cracking with John the Ripper | Documented | Supporting cybersecurity project |
| CrowdStrike Website Development | Documented | Early web/ICT project |
| Telecom Cybersecurity Presentation | Documented | Academic archive |
| Relations and Their Properties | Documented | Academic archive |
| Cybersecurity in Pakistan Presentation | Documented | Communication and awareness project |
| Islamic Studies and Ethics Debate/Class Participation | Completed | Non-technical academic participation record |

---

## Non-Archived Coursework Notes

Some semester activities were completed but are not represented by standalone public project folders.

| Course / Component | Reason |
|---|---|
| Islamic Studies and Ethics | Debate and class participation activity; acknowledged in the semester README, but no separate technical artifact is available for public archiving |

This keeps the repository honest and avoids creating artificial folders for activities that do not have meaningful public evidence.

---

## Academic and Portfolio Notes

Semester 1 projects are early academic projects. They are intentionally preserved to show the beginning of my cybersecurity learning journey, including foundational programming, communication, ICT, mathematics, ethics, and security awareness.
...
The Islamic Studies and Ethics activity is included as a non-technical academic participation component and is not represented as a cybersecurity or software project.
